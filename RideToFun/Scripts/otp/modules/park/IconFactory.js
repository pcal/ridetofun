...
var SmallIcon0Pct = L.Icon.extend({
    iconUrl: 'images/ico-park-sm.png',
    shadowUrl: null,
...
otp.modules.park.IconFactory = new otp.Class({
    ...
    getSmall : function(park) {
        return this.small100;
    },   

    getMedium : function(park) {
        return this.medium100;
    },   

    getLarge: function (park) {
        return this.large100;
    },  
                
    CLASS_NAME : "otp.modules.park.IconFactory"
});    
